    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("功能设置") {
                    NavigationLink {
                        RoomScanSettingsView()
                    } label: {
                        Label("房间工程扫描", systemImage: "house")
                    }
                    NavigationLink {
                        ObjectScanSettingsView()
                    } label: {
                        Label("物体工程扫描", systemImage: "cube.transparent")
                    }
                    NavigationLink {
                        WallDefectSettingsView()
                    } label: {
                        Label("墙地面缺陷扫描", systemImage: "paintbrush.pointed")
                    }
                }
